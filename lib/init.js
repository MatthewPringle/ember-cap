...
module.exports = {
    ...
    checkPackageValid: function() {
        try {
            ...
            if ( !data || typeof data !== 'object' || !data.hasOwnProperty( 'dependencies' ) ) {
                throw 'Invalid package.json';
            }
            return true;
        } catch( error ) {
    ...
    checkEmber: function() {
        try {
            ...
            if ( !data.dependencies.hasOwnProperty( 'ember-cli' ) ) {
    ...
    checkCapacitor: function() {
        try {            
            let data = JSON.parse( fs.readFileSync( './package.json' ) );
            if ( data.dependencies.hasOwnProperty( '@capacitor/cli' ) || data.dependencies.hasOwnProperty( '@capacitor/core' ) || fs.existsSync( './capacitor.config.json' ) ) {

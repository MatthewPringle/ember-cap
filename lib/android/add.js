...
module.exports = async function( platform ) {
    try {
        ...
        console.log( json.manifest.application );
        ...
        //if (  json.manifest.application[ '$' ][ 'android:usesCleartextTraffic' ] === undefined ) {
            
            //json.manifest.application[ '$' ][ 'android:usesCleartextTraffic' ] = 'true';
